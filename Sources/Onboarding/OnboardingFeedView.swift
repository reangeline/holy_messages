    ...
    var body: some View {
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: 18) {
                    ...
                    Button(action: onContinue) {
                        LiturgicalGradientCard(color: .red) {
                            VStack(alignment: .leading, spacing: 8) {
                                Eyebrow(text: "Today's verse", color: Palette.goldBright)
                    ...
                    Button(action: onContinue) {
                        VStack(alignment: .leading, spacing: 6) {
                            Eyebrow(text: "The Mass, part by part · 1 of 14")
                ...
                OnboardingPrimaryButton(title: "Look around \u{2014} no account needed", action: onContinue)
