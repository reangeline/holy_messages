...
Missale has no account, no server, and makes no network requests. Nothing you
write or log leaves your device. We do not receive your data, because there is
...
- **No account, no sign-in.** We never ask for an email, phone number,
  password, or any other identifier.
- **No network requests.** The app contains no networking code.
...
- **No ads.**
- **We do not sell, rent, or share data.** There is no data of ours to sell.
...
Missale is not directed at children, and it collects no data from anyone, of
any age.

## Your rights (GDPR, CCPA, LGPD)

The GDPR, CCPA, and LGPD give you rights of access, correction, deletion, and
